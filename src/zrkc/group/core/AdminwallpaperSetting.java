package zrkc.group.core;

import zrkc.group.utils.BaseUtils.*;
...
//        更改缓存
    ...
    public void setData(Data data) throws Exception {
        try {
            this.setServer(data.getServer_host(), data.getServer_port(), data.getServer_username(), data.getServer_password(), data.getServer_http_root());
            this.setUser_root(data.getUser_root());
            this.setName_Base(data.getName_base());
        } catch (Exception e) {
            throw e;
        }
    }
